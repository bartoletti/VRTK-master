...
namespace VRTK
{
    ...
    public class VRTK_DestinationPoint : VRTK_DestinationMarker
    {
        ...
        protected virtual Quaternion? GetRotation()
        {
            ...
            //return Quaternion.Euler(destinationLocation.eulerAngles.x, destinationLocation.eulerAngles.y + offset, destinationLocation.eulerAngles.z);
            //return Quaternion.Euler(destinationLocation.eulerAngles.x, destinationLocation.eulerAngles.y, destinationLocation.eulerAngles.z);
